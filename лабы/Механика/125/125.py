...
Omega = np.array([34.28189219, 56.98517323, 111.8004484, 170.5533442, 213.7137823])/1000
m = np.array([56.0, 91.4, 178.9, 272.1, 340.4])
M = (m*9.81)*1.21
print(M)
koef1, koef2 = mnk(M, Omega)
plt.plot(M, M*koef1 + koef2, color = 'r', label = 'линейная аппроксимация')
plt.scatter(M, Omega, color =  'black', label=f'', s = 20, linewidth = 0) # наносим прямую и задаем ей название
...
plt.xlabel('Момент силы тяжести, Н*м')#подпись оси X
plt.ylabel('Скорость прецессии, рад/c^2')#подпись оси Y
